...
public class Verticex  <V extends Comparable<V>,K extends Comparable<K>,A>
{
	 ...
	 */
	public Verticex(K pLlave,V pValueVertex)
	{
		//el metodo agregar arco tiene un factor de carga maximo del 0.75
		llaveId = pLlave;
		infoVertex = new Arcox[100000];
	...
	{
		//CAMBIAR
		Arcox[] copiaHash= infoVertex; //se crea un copia con los arcos actuales
		infoVertex = new Arcox[infoVertex.length*2];//se aumenta la tabla del HashTableLinear
